...
if __name__ == "__main__":
    ...
    parser.add_argument("--setup_wandb", type=int, default=True)
    ...
    parser.add_argument("--resume", type=float, default=True)
    ...
    parser.add_argument("--epoch_to_load", type=int, default=10)
